...
filename <- paste0("FD_Growth_Effect_",iclass,"_CHN_Forecast.xlsx")
...
load(paste0(rdata,"ICIO_",iclass,"_matrix_2011.RData"))    # These RData include all necessary data for analysis
rm(icio)
